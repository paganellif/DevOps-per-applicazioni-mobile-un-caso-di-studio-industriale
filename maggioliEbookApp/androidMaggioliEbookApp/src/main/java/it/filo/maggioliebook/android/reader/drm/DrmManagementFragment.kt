...
import it.filo.maggioliebook.android.databinding.FragmentDrmManagementBinding
...
private fun Date?.toFormattedString() = DateTime(this).toString(DateTimeFormat.shortDateTime())
