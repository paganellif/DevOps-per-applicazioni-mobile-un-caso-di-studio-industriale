...
import it.filo.maggioliebook.android.databinding.ItemRecycleHighlightBinding
...
class HighlightsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        highlightAdapter = HighlightAdapter(publication,
            onDeleteHighlightRequested = { highlight -> viewModel.removeHighlightById(highlight.id!!) },
    ...
    private fun onHighlightSelected(highlight: Highlight) {
        setFragmentResult(
                ...
                OutlineContract.createResult(highlight.toLocator())
        )
    }
}
...
class HighlightAdapter(private val publication: Publication,
    ...
    inner class ViewHolder(val binding: ItemRecycleHighlightBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(highlight: Highlight) {
            ...
            binding.highlightText.text = highlight.toLocator().text.highlight
            binding.annotation.text = highlight.annotation

            val formattedDate = DateTime(highlight.createdDate).toString(DateTimeFormat.shortDateTime())
