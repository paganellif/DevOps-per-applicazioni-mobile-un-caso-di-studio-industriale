...
import it.filo.maggioliebook.android.utils.extensions.toDataUrl
import it.filo.maggioliebook.android.reader.search.SearchFragment
import it.filo.maggioliebook.android.settings.UserSettings
        ...
        return when (item.itemId) {
            R.id.settings -> {
                userSettings.userSettingsPopUp()
                    .showAsDropDown(requireActivity().findViewById(R.id.settings),
                        0, 0, Gravity.END)
                true
            }
            R.id.search -> {
