...
import it.filo.maggioliebook.android.databinding.SectionHeaderBinding
...
class SectionDecoration(
    ...
    private fun fixLayoutSize(v: View, parent: ViewGroup) {
        ...
        val childWidth = ViewGroup
            .getChildMeasureSpec(widthSpec, parent.paddingStart + parent.paddingEnd, v.layoutParams.width)
        val childHeight = ViewGroup
            .getChildMeasureSpec(heightSpec, parent.paddingTop + parent.paddingBottom, v.layoutParams.height)
